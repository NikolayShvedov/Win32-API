...
{
    public partial class ChangeDisplaySettingsForm : Form
    {
        public ChangeDisplaySettingsForm()
        {
            InitializeComponent();
        }
        ...
        private void buttonChangeDisplaySettings_Click(object sender, EventArgs e)
        {
            int width = int.Parse(textWidth.Text);
            int height = int.Parse(textHeight.Text);
            CResolution ChangeRes = new CResolution(width, height);
        }
    }
}
